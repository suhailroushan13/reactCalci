    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white p-6 rounded-lg shadow-xl w-80">
        ...
        <div className="grid grid-cols-4 gap-2">
          <button className="btn bg-gray-300" onClick={clearDisplay}>C</button>
          <button className="btn bg-gray-300" onClick={() => appendToDisplay("(")}> ( </button>
          <button className="btn bg-gray-300" onClick={() => appendToDisplay(")")}>)</button>
          <button className="btn bg-yellow-400" onClick={() => appendToDisplay("/")}>/</button>
          ...
          <button className="btn bg-yellow-400" onClick={() => appendToDisplay("+")}>+</button>
          <button className="btn col-span-2" onClick={() => appendToDisplay("0")}>0</button>
          <button className="btn" onClick={() => appendToDisplay(".")}>.</button>
          <button className="btn bg-green-400" onClick={calculate}>=</button>
        </div>
      </div>
    </div>
  );
...
const btnStyle = "bg-gray-200 text-xl font-semibold p-4 rounded shadow hover:bg-gray-300";
